@extends('admin')
	...
	@section('content')
		...
		{{ Form::open(array('url'=>'vicenda','class'=>'pure-form pure-form-aligned')) }}
        ...
        <div class="form-group col-sm-10 col-sm-offset-1 col-xs-12 ">
			...
			{{ Form::select('live', $selectEventi, Input::old('live'), ['class'=>'form-control'])}}
		</div>
		</div>
        ...
        <div class="form-group col-sm-10 col-sm-offset-1 col-xs-12 ">
			...
			{{ Form::select('trama', $selectTrama, Input::old('trama'), ['class'=>'form-control'])}}
		</div>
		</div>
