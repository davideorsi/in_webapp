@extends('admin')
	...
	@foreach( $vicende as $vicenda)	
		...
		<div class='row' style='position:relative; border-left: 5px solid {{$vicenda->color}}; margin-bottom:20px;'>
			...
			{{ Form::button('<span class="glyphicon glyphicon-floppy-disk"></span>', array('type'=>'submit','class' => 'btn btn-default btn-lg btn-flat', 'style'=>'position:absolute; top:0px; left:-60px;')) }}
		...
		{{ Form::close() }}
			...
			@foreach($vicenda->schedule as $elemento)
				<div class='col-xs-12' style='position:relative; top:-50px; margin-bottom:-50px;'>
					...
					<div class="form-group col-xs-offset-1 col-xs-11 " style='border-left: solid 5px #ccc; padding-bottom:5px;'>
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon-titolo">Titolo</span>
							{{ Form::text('text',Input::old('text'), ['class'=>'form-control','describedby'=>"basic-addon-titolo"]) }}
						</div>
					</div>
					<div class="form-group col-xs-offset-1 col-xs-5 " style='border-left: solid 5px #ccc; top:-15px;'>
						<div class="input-group">
					...
					<div class="form-group col-xs-offset-1 col-xs-5 " style=' top:-15px;'>
						<div class="input-group">
					...
					{{ Form::button('<span class="glyphicon glyphicon-floppy-disk"></span>', array('type'=>'submit','class' => 'btn btn-default btn-lg btn-flat', 'style'=>'position:absolute; top:0px; left:45px;')) }}
